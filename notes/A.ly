...
VerbirgAltoNotes = {
  \relative c' {
    ...
    cis cis r cis' a4 r
    r h g!8 g h a
    a d, r16 gis gis a a8 a \clef "treble_8" g4^\soloTenore
    r g8 fis e4 r8 e
    e e fis cis d4 r16 d d cis %10
    h8. h16 cis8 gis a4 r8 cis
    a8. a16 gis8 fis d'4 r8 d
    d d cis h e e r e
    gis8. gis16 fis8 e a a \clef treble r e'^\soloSoprano
...
WasDuencketAltoNotes = {
  \relative c' {
    ...
    R1*3 %12
    r2 r4 \clef bass r16 g,^\soloBasso h g
    e8. e16 d8 c fis fis r16 fis fis g
    a8 d, c' h g g r d %15
    fis a c h h4 r
    R1*7 %23
    \tempoWasDuencketD \clef treble r4 r8 e^\soloAlto a8. a16 e8 c
